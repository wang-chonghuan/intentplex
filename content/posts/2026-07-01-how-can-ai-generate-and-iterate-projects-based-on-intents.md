...
1. First, create the GitHub repo, server, domain, database, LLM, and other resources.

2. Initialize the project framework: TanStack Start, Python pipelines, Prefect, crawl4ai, Clerk, PostHog.

3. Initialize my harness system: EvoDocs, IntentMill, AutoQA, and plane.so, Codex/CC, design.md.
